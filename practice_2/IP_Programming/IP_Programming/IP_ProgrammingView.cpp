...
BEGIN_MESSAGE_MAP(CIPProgrammingView, CScrollView)
	...
	ON_COMMAND(ID_FILE_PRINT_PREVIEW, &CIPProgrammingView::OnFilePrintPreview)
	ON_WM_CONTEXTMENU()
	ON_WM_RBUTTONUP()
END_MESSAGE_MAP()
...
void CIPProgrammingView::OnFilePrintPreview()
{
#ifndef SHARED_HANDLERS
...
void CIPProgrammingView::OnRButtonUp(UINT /* nFlags */, CPoint point)
{
	ClientToScreen(&point);
	OnContextMenu(this, point);
}

void CIPProgrammingView::OnContextMenu(CWnd* /* pWnd */, CPoint point)
{
#ifndef SHARED_HANDLERS
